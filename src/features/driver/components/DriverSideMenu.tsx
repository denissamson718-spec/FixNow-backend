...
const menuItems = [
  ...
  { label: "Rescue", route: "Rescue", icon: "car-sport-outline" },
  { label: "Nearby places", route: "NearbyPlaces", icon: "map-outline" },
...
export function DriverSideMenu() {
  ...
  const openRoute = (route: string) => {
    setIsOpen(false);
    if (route === "NearbyPlaces") {
      navigation.navigate("NearbyPlaces");
      return;
    }
    navigation.navigate("DriverTabs", { screen: route });
  };
          ...
          <SafeAreaView style={styles.drawer} edges={["top", "bottom"]}>
            ...
            >
              ...
              <View style={styles.profileCopy}>
                <Text numberOfLines={1} style={styles.name}>{userName || "Driver"}</Text>
              </View>
            ...
            <View style={styles.menuInfo}>
              ...
              <Text style={styles.menuInfoText}>Your FixNow account and roadside requests remain available from this menu.</Text>
            </View>
          </SafeAreaView>
        </View>
      </Modal>
